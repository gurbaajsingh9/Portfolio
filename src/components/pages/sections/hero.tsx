      ...
      <div className="px-4 pb-6 md:px-8 md:pb-14 lg:px-20">
        ...
        >
          ...
          <div className="md:flex-1">
            ...
            >
              Software developer and AI/ML engineer building at the intersection of LLMs, data, and systems that actually ship. Currently exploring RAG pipelines, computer vision, and automation — always shipping something new.
            </motion.p>
            ...
            >
              ...
              <Button
                ...
                className="group/btn border-2 font-medium"
              >
                <Link href={"/Gurbaj Resume Latest.pdf"}>
