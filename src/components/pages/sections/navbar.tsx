...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur-md px-4 py-2.5 md:px-8">
      <div className="flex items-center justify-between gap-4">
        ...
        >
          ...
          <AnimatedTextLogo text="Gurbaj" className="text-2xl" hover />
        ...
        {/* Desktop Nav */}
        <div className="bg-background/50 font-incognito relative hidden items-center rounded-full backdrop-blur-sm md:flex">
          {/* Overlay layer  */}
          <div
            ref={overlayRef}
