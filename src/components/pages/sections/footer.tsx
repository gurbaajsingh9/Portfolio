    ...
    <footer className="border-t px-4 py-3.5 md:px-8">
      <div className="text-foreground/70 flex flex-col items-center justify-between gap-3 text-sm md:flex-row">
        ...
        <div className="inline-flex items-center gap-2">
          <Image src="/signature-logo.svg" alt="Signature" width={100} height={32} className="block dark:hidden object-contain" />
          <Image src="/white-signature-logo.svg" alt="Signature" width={100} height={32} className="hidden dark:block object-contain" />
          <span>© {dayjs().year()} Gurbaj. All rights reserved.</span>
        </div>
